        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 mt-[4rem] gap-[3rem] w-[80%] mx-auto">
          <div>
            ...
            <div className="w-[90%] text-center mx-auto bg-[#09101a] relative p-[2rem] mt-[1rem]">
              <div
                className="w-fit px-[2rem] py-[1rem] bg-lime-green relative mt-[-3rem] text-black font-semibold
                  text-[17px] mx-auto"
              >
                December 10,2023
              </div>
              <div className="flex flex-col md:flex-row items-center mt-[1rem] space-x-4">
                <div className="flex items-center space-x-3">
                  <UserCircleIcon className="w-[1.5rem] mx-auto h-[1.5rem] text-lime-green" />
                  <p className="text-white">By Ismael</p>
                </div>
                <div className="flex items-center space-x-3">
                  <ChatBubbleLeftRightIcon className="w-[1.5rem] mx-auto h-[1.5rem] text-lime-green" />
