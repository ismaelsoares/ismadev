   ...
   return (
      <div className="h-full bg-primary/60">
         ...
         <div className="w-[1200px] h-full absolute right-0 bottom-0">
            {/* bg img */}
            <div className="absolute w-full h-full bg-none xl:bg-explosion xl:bg-cover xl:bg-right x l:bg-no-repeat mix-blend-color-dodge translate-z-0">
            </div>
            {/* particles */}
            <ParticlesContainer />
            {/* avatar img */}
            <motion.div
               ...
               className="w-full h-full max-w-[737px] max-h-[678px] absolute -bottom-4
