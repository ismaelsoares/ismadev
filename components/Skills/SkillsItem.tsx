   ...
   return (
      <div className="mb-[4rem] md:mb-[8rem]">
         ...
         <p className="text-[#aaaaaa] font-normal w-[80%] text-[17px] opacity-80">
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Minus, id in. Velit in minima, atque ea asperiores
            nisi odit odio reiciendis! Accusamus ullam ex aperiam laboriosam commodi blanditiis inventore optio.
         </p>
      </div>
   )
}