            ...
            <div>
               ...
               <div className="mb-[3rem] flex items-center md:space-x-10">
                  ...
                  <p className="text-[19px] text-slate-300 w-[80%]">
                     Concursado desde os 18 anos, amante de tecnologia,
                     autodidata, comecei com manutenção e montagem de
                     computadores. No trabalho, fazia manutenção dos
                     laboratórios do programa PROINFO, utilizando o SO Linux
                     Educacional, inclusive liderei um projeto piloto de ensino
                     de informática para crianças e adolescentes. Mas foi na
                     faculdade que ampliei meus horizontes sobre tecnologia,
                     sobretudo programação. Me formei desenvolvendo um armário
                     inteligente, utilizando Arduíno e RFID, sendo inclusive
                     publicado na UEMA e UESPI.
                  </p>
               </div>
               <button
