        ...
        <div>
          ...
          <div className="mb-[3rem] flex items-center md:space-x-10">
            ...
            <p className="text-base dark:text-slate-300 w-[80%]">
              ...
              o SO Linux Educacional, inclusive liderei um projeto piloto de
              ensino de informática para crianças e adolescentes. Mas foi na
              faculdade que ampliei meus horizontes sobre tecnologia, sobretudo
              programação. Me formei desenvolvendo um armário inteligente,
              utilizando Arduíno e RFID, sendo inclusive publicado na UEMA e
              UESPI.
            </p>
          </div>
          <button
